...
export default class TimeService{
     ...
     static getFirstAvailableDate =  () =>
    {
        ...
        return API.get('/api/blood/time/getfirstavaiabledate');
    }
    ...
    {        
       ...
       return API.get('/api/blood/time/getfullybookeddays');
    }
    ...
    static getTimeSlots = (date) =>
    {
        ...
        return API.get(`/api/blood/time/gettimeslots?date=${date_utc}`);
    }
