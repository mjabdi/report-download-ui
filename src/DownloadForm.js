    ...
    <React.Fragment>
      ...
      <main className={classes.layout}>
        <Paper className={classes.paper}>
          ...
          >
            Your report is ready to download now
       
          </div>

        <a href={`https://londonmedicalclinic.co.uk/medicalexpressclinic/download/pdf/downloadpdflabreport?id=${state.bloodReport._id}`} style={{textDecoration:"none"}}>
          <Button
            variant="contained"
